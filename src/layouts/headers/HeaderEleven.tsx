  ...
  return (
    <>
      <header className="it-header-height">
        <div id="header-sticky" className={`it-header-wrap p-relative it-header-style-6 ${sticky ? 'header-sticky' : ''}`}>
          <div className="it-header-logo-2 d-none d-xl-flex">
            <Link to="/"><img src="assets/img/logo/logo-fitness.png" alt="" /></Link>
          </div>
          {/* <!-- header-top-area-start --> */}
          <div className="it-header-top-area  black-bg it-header-top-ptb">
            <div className="container">
              <div className="it-header-ml">
                <div className="row align-items-center">
                  <div className="col-xxl-8 col-xl-8 col-lg-7 col-md-6 col-sm-5">
                    <div
                      className="it-header-top-contact-wrap d-flex align-items-center justify-content-center justify-content-sm-start">
                      <ul>
                        ...
                        <li className="d-none d-lg-inline-block">
                          <div className="it-header-top-contact d-flex align-items-center">
                            <span>
                              <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_2294_12283)">
                                  <path
                            ...
                            <a className="border-line" target="_blank"
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-5 col-md-6 col-sm-7 d-none d-sm-block">
                    <div className="it-header-top-social-box d-flex align-items-center justify-content-end">
                      <a href="#">
          ...
          {/* <!-- header-top-area-end --> */}
          {/* <!-- header-area-start --> */}
          <div className="it-header-area it-header-ptb">
            <div className="container">
              <div className="it-header-ml">
                <div className="row align-items-center">
                  <div className="col-xl-3 col-lg-4 col-md-5 col-6 d-xl-none">
                    <div className="it-header-logo">
                      <Link to="/"><img src="assets/img/logo/logo-fitness-black.png" alt="" /></Link>
                    </div>
                  </div>
                  ...
                  <div className="col-xxl-5 col-xl-4 col-lg-8 col-md-7 col-6">
                    <div className="it-header-2-right-action d-flex justify-content-end align-items-center">
                      ...
                      <Link to="/courses-with-filter" className="it-btn-yellow theme-5-bg d-none d-md-flex">
                        <span>
                          <span className="text-1">Join Class Now</span>
                          <span className="text-2">Join Class Now</span>
                        </span>
                        <i>
