  ...
  return (
    <>
      <header className="it-header-height">
        {/* <!-- header-area-start --> */}
        <div id="header-sticky" className={`it-header-area it-header-style-5 p-relative white-bg it-header-ptb ${sticky ? "header-sticky" : ""}`}>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xxl-3 col-xl-3 col-lg-8 col-md-7 col-6">
                <div className="it-header-2-right-action d-flex justify-content-end align-items-center">
                  <a className="it-header-cart d-none d-xxl-block" href="#">
