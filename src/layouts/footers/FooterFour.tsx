  ...
  return (
    <>
      <footer>
        ...
        {/* <!-- footer-area-start --> */}
        <section className="it-footer-wrap it-footer-style-3 fix">
          <div className="it-footer-area z-index-1 pb-80" style={{ backgroundImage: `url(/assets/img/shape/footer-bg-4-1.jpg)` }}>
