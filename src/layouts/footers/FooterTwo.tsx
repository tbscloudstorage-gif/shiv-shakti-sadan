  ...
  return (
    <>
      <footer>
        ...
        {/* <!-- footer-area-start --> */}
        <section className="it-footer-wrap gray-bg it-footer-style-2 fix">
          <div className="it-footer-area z-index-1 pt-200 pb-50" style={{ backgroundImage: `url(/assets/img/shape/footer-bg-2-1.jpg)` }}>
            <img className="it-footer-shape-1" src="assets/img/shape/footer-2-1.png" alt="" />
          ...
          <div className="it-copyright-area it-copyright-ptb it-copyright-bg z-index-1 black-bg">
            <div className="container">
