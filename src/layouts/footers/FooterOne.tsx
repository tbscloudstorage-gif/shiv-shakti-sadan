...
export default function FooterOne() {
  return (
    <>
      <footer>
        {/* <!-- footer-area-start --> */}
        <div className="it-footer-wrap fix">

          <div className="it-footer-area z-index-1 pt-130 pb-80" style={{backgroundImage: "url(/assets/img/shape/footer-bg-1-1.jpg)"}}>
            <img className="it-footer-shape-3" data-parallax='{"y": -200, "smoothness": 30}' src="assets/img/shape/footer-1-1.png" alt="" />
          ...
          <div className="it-copyright-area it-copyright-ptb it-copyright-bg z-index-1 yellow-bg">
            <div className="container">
