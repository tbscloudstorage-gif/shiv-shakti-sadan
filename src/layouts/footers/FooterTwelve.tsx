...
export default function FooterTwelve() {
  return (
    <>
      <footer>
        {/* <!-- footer-area-start --> */}
        <div className="it-footer-wrap it-footer-style-5 it-footer-style-8">
          <div className="it-footer-area z-index-1 theme-bg pt-200 pb-80" style={{ backgroundImage: `url(/assets/img/shape/footer-9-1.png)` }}>
              ...
              <div className="row">
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  ...
                  <div className="it-footer-widget it-footer-col-1-2">
                    <h4 className="it-footer-widget-title">Quick Links</h4>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".9s">
                  <div className="it-footer-widget it-footer-col-1-4 d-flex justify-content-xl-end">
                    <div>
                      <h4 className="it-footer-widget-title">Gallery</h4>
                      <div className="it-footer-widget-contact-4 mb-25">
                        <ul>
                          <li>
                            <a href="tel:+91123456789">
                              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.1094 1C12.1094 1 14.5538 1.22222 17.6649 4.33332C20.776 7.44442 20.9982 9.88886 20.9982 9.88886" stroke="#F8C62F" strokeWidth="2" strokeLinecap="round" />
                                <path d="M12.3398 4.92773C12.3398 4.92773 13.4398 5.242 15.0897 6.89191C16.7396 8.54182 17.0539 9.64176 17.0539 9.64176" stroke="#F8C62F" strokeWidth="2" strokeLinecap="round" />
                                <path opacity="0.5" d="M7.70841 4.68702L8.42954 5.97916C9.08031 7.14525 8.81907 8.67496 7.7941 9.69993C7.7941 9.69993 6.55085 10.9432 8.80499 13.1973C11.0591 15.4514 12.3024 14.2082 12.3024 14.2082C13.3274 13.1833 14.8571 12.922 16.0232 13.5728L17.3153 14.2939C19.0761 15.2766 19.2841 17.7459 17.7364 19.2937C16.8064 20.2237 15.6671 20.9473 14.4076 20.9951C12.2875 21.0754 8.68695 20.5389 5.07521 16.9271C1.46347 13.3154 0.926905 9.71484 1.00728 7.59469C1.05502 6.33527 1.77867 5.19598 2.70867 4.26597C4.25638 2.71826 6.72573 2.92621 7.70841 4.68702Z" stroke="#F8C62F" strokeWidth="2" strokeLinecap="round" />
                              </svg>
                              (+91) 123-456-789
                            </a>
                          </li>
                          <li>
                            <a href="mailto:educeet@gmail.com">
                              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.75 16.75C13.1683 16.75 16.75 13.1683 16.75 8.75C16.75 4.33172 13.1683 0.75 8.75 0.75C4.33172 0.75 0.75 4.33172 0.75 8.75C0.75 10.0297 1.05049 11.2393 1.58477 12.312C1.72675 12.597 1.77401 12.9229 1.69169 13.2305L1.21521 15.0113C1.00836 15.7844 1.71561 16.4916 2.48868 16.2848L4.26951 15.8083C4.57715 15.726 4.90297 15.7733 5.18802 15.9152C6.26069 16.4495 7.47025 16.75 8.75 16.75Z" stroke="#F8C62F" strokeWidth="1.5" />
                                <path opacity="0.5" d="M5.55078 7.55078H11.9508" stroke="#F8C62F" strokeWidth="1.5" strokeLinecap="round" />
                                <path opacity="0.5" d="M5.55078 10.3506H9.95078" stroke="#F8C62F" strokeWidth="1.5" strokeLinecap="round" />
                              </svg>
                              contact@info.com
                            </a>
                          </li>
                          <li>
                            <a target="_blank" href="https://www.google.com/maps/dir///@24.4503253,17.1644279,4.17z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5" d="M3.44922 6.61317C3.44922 3.37503 6.26983 0.75 9.74922 0.75C13.2286 0.75 16.0492 3.37503 16.0492 6.61317C16.0492 9.82594 14.0385 13.5749 10.9013 14.9156C10.1699 15.2281 9.32849 15.2281 8.59716 14.9156C5.45996 13.5749 3.44922 9.82594 3.44922 6.61317Z" stroke="#F8C62F" strokeWidth="1.5" />
                                <path d="M11.5492 7.05C11.5492 8.04411 10.7433 8.85 9.74922 8.85C8.75511 8.85 7.94922 8.04411 7.94922 7.05C7.94922 6.05589 8.75511 5.25 9.74922 5.25C10.7433 5.25 11.5492 6.05589 11.5492 7.05Z" stroke="#F8C62F" strokeWidth="1.5" />
                                <path d="M17.8145 12.9004C18.4133 13.4426 18.75 14.0538 18.75 14.7004C18.75 16.9371 14.7206 18.7504 9.75 18.7504C4.77944 18.7504 0.75 16.9371 0.75 14.7004C0.75 14.0538 1.08671 13.4426 1.68552 12.9004" stroke="#F8C62F" strokeWidth="1.5" strokeLinecap="round" />
                              </svg>
                              1234 North Avenue Luke Lane,<br /> South Bend,</a>
                          </li>
                        </ul>
                      </div>
                    </div>
