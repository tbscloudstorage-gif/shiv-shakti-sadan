...
export default function FooterNine() {
  return (
    <>
      <footer>
        {/* <!-- footer-area-start --> */}
        <section className="it-footer-wrap it-footer-style-5 it-footer-style-8 it-footer-style-9 p-relative">
          <img className="it-footer-bg" src="assets/img/shape/footer-8-bg.png" alt="" />
          {/* <!-- newsletter-area-start --> */}
          <div className="it-newsletter-area pt-110 mb-100">
            <div className="container">
              <div className="it-newsletter-wrap it-newsletter-style-3">
                <div className="row align-items-center">
                  <div className="col-lg-6">
                    <div className="it-newsletter-2-left">
                      <h4 className="it-newsletter-2-title text-white mb-0">Become A Part Of our Community</h4>
                    </div>
                  </div>
                  <div className="col-lg-6">
          ...
          {/* <!-- newsletter-area-end --> */}
          <div className="it-footer-area z-index-1 pb-50">
            <div className="container">
              <div className="row">
                <div className="col-xl-3 col-lg-4 col-md-5 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".5s">
                  <div className="it-footer-widget it-footer-col-8-1">
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".7s">
                  <div className="it-footer-widget it-footer-col-8-2">
                    <h4 className="it-footer-widget-title">Quick Links</h4>
                    <div className="it-footer-widget-menu">
                      <ul>
                        <li><a href="#">Quran Learning</a></li>
                        <li><a href="#">Guided Tour</a></li>
                        <li><a href="#">Online Quran Learn</a></li>
                        <li><a href="#">Quran Gideline</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div className="col-xl-2 col-lg-3 col-md-3 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".7s">
                  <div className="it-footer-widget it-footer-col-8-3">
                    <h4 className="it-footer-widget-title">Support</h4>
                    <div className="it-footer-widget-menu">
                      <ul>
                ...
                <div className="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".7s">
                  <div className="it-footer-widget it-footer-col-8-4">
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".9s">
                  <div className="it-footer-widget it-footer-col-8-5 d-flex justify-content-xl-end">
                    <div>
                      <h4 className="it-footer-widget-title">Gallery</h4>
                      <div className="it-footer-widget-gallery-wrap">
                        <div className="it-footer-widget-gallery-item">
                          <a href="#">
                            <img src="assets/img/contact/gallery-1.jpg" alt="" />
                          </a>
                        </div>
                        <div className="it-footer-widget-gallery-item">
                          <a href="#">
                            <img src="assets/img/contact/gallery-2.jpg" alt="" />
                          </a>
                        </div>
                        <div className="it-footer-widget-gallery-item">
                          <a href="#">
                            <img src="assets/img/contact/gallery-3.jpg" alt="" />
                          </a>
                        </div>
                        <div className="it-footer-widget-gallery-item">
                          <a href="#">
                            <img src="assets/img/contact/gallery-4.jpg" alt="" />
                          </a>
                        </div>
                        <div className="it-footer-widget-gallery-item">
                          <a href="#">
                            <img src="assets/img/contact/gallery-5.jpg" alt="" />
                          </a>
                        </div>
                        <div className="it-footer-widget-gallery-item">
                          <a href="#">
                            <img src="assets/img/contact/gallery-6.jpg" alt="" />
                          </a>
                        </div>
                      </div>
                    </div>
          ...
          <div className="it-copyright-area it-copyright-style-3 it-copyright-ptb">
            <div className="container">
              <div className="row align-items-center">
                <div className="col-xl-6 col-lg-5 col-md-6">
                  <div className="it-copyright-left style-2 text-center text-md-start">
                    <p className="mb-0">Copyright Â© {new Date().getFullYear()} <a href="#">Ordianit</a> All Rights Reserved</p>
                  </div>
                </div>
