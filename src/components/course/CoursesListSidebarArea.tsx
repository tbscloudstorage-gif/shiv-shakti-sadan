...
export default function CoursesListSidebarArea() {
            ...
            <div className="row">
              ...
              <div className="col-lg-8 order-0 order-lg-1">
                <div className="tab-content" id="myTabContent">
                  <div className="tab-pane fade" id="Grid" role="tabpanel" aria-labelledby="Grid-tab">
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="it-course-item mb-35">
                          ...
                          <div className="it-course-content p-relative">
                            ...
                            <h5 className="it-course-title mb-20"><Link className="border-line" to="/courses-details-v1">Design Thinking Researching for Better UX</Link></h5>
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="it-course-item mb-35">
                          ...
                          <div className="it-course-content p-relative">
                            ...
                            <h5 className="it-course-title mb-20"><Link className="border-line" to="/courses-details-v1">Discover Highly Rated Learning Programs</Link></h5>
                            <div className="it-course-rating mb-10">
                              <div>
                                <i className="fa-sharp fa-solid fa-star"></i>
                                <i className="fa-sharp fa-solid fa-star"></i>
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="it-course-item mb-35">
                          ...
                          <div className="it-course-content p-relative">
                            ...
                            <h5 className="it-course-title mb-20"><Link className="border-line" to="/courses-details-v1">Boost Your Skills with Popular Courses</Link></h5>
                            <div className="it-course-rating mb-10">
                              <div>
                                <i className="fa-sharp fa-solid fa-star"></i>
                                <i className="fa-sharp fa-solid fa-star"></i>
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="it-course-item mb-35">
                          ...
                          <div className="it-course-content p-relative">
                            ...
                            <h5 className="it-course-title mb-20"><Link className="border-line" to="/courses-details-v1">Learn from the Best â€“ Student Favorite Programs</Link></h5>
                            <div className="it-course-rating mb-10">
                              <div>
                                <i className="fa-sharp fa-solid fa-star"></i>
                                <i className="fa-sharp fa-solid fa-star"></i>
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="it-course-item mb-35">
                          ...
                          <div className="it-course-content p-relative">
                            ...
                            <h5 className="it-course-title mb-20"><Link className="border-line" to="/courses-details-v1">Upgrade Your Knowledge with Expert Courses</Link></h5>
                            <div className="it-course-rating mb-10">
                              <div>
                                <i className="fa-sharp fa-solid fa-star"></i>
                                <i className="fa-sharp fa-solid fa-star"></i>
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="it-course-item mb-35">
                          ...
                          <div className="it-course-content p-relative">
                            ...
                            <h5 className="it-course-title mb-20"><Link className="border-line" to="/courses-details-v1">First Aid and Child Safety Essentials Course</Link></h5>
                            <div className="it-course-rating mb-10">
                              <div>
                                <i className="fa-sharp fa-solid fa-star"></i>
                                <i className="fa-sharp fa-solid fa-star"></i>
