...
export default function CoursesWithFilterArea() {
  return (
    <>
      {/* <!-- course-area-start --> */}
      <div className="it-course-area pt-130 pb-130">
            ...
            <div className="col-12">
              <div className="it-pagination text-center mt-45">
                <nav>
                  <ul>
                    <li>
                      <Link to="/courses-with-filter">
                        <i className="fa-regular fa-arrow-left"></i>
                      </Link>
                    </li>
                    <li>
                      <Link to="/courses-with-filter">1</Link>
                    </li>
                    <li className="current">
                      <Link to="/courses-with-filter">2</Link>
                    </li>
                    <li>
                      <Link to="/courses-with-filter">3</Link>
                    </li>
                    <li>
                      <Link to="/courses-with-filter">4</Link>
                    </li>
                    <li>
                      <Link to="/courses-with-filter">
