...
export default function ShopProductModal() {
  return (
    <>
      {/* <!-- modal-area-start --> */}
      <div className="modal fade it-shop-modal" id="producQuickViewModal" tabIndex={-1} aria-labelledby="producQuickViewModal"
        aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="it-shop-modal-content d-lg-flex align-items-center">
              <button type="button" className="it-shop-modal-close-btn" data-bs-toggle="modal"
                data-bs-target="#producQuickViewModal"><i className="fa-regular fa-xmark"></i></button>
              <div className="it-shop-details-thumb-wrapper it-tab d-sm-flex">
                <nav>
                  <div className="nav nav-tab flex-sm-column " id="productDetailsNavThumb" role="tablist">
                    ...
                    <button className="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2"
                      ...
                      <img src="assets/img/shop/details-1-2.jpg" alt="" />
                    </button>
                ...
                <div className="tab-content m-img" id="productDetailsNavContent">
                  <div className="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab"
                    tabIndex={0}>
                    <div className="it-shop-details-nav-main-thumb">
                      <img src="assets/img/shop/details-1-1.jpg" alt="" />
                    </div>
                  </div>
              ...
              <div className="it-shop-details-wrapper">
                <h3 className="it-shop-details-title">Happy & Strong</h3>

                {/* <!-- inventory details --> */}
                <div className="it-shop-details-inventory d-flex align-items-center mb-10">
                  <div className="it-shop-details-stock mb-10">
                    <span>In Stock</span>
                  </div>
                  <div className="it-shop-details-rating-wrapper d-flex align-items-center mb-10">
                    <div className="it-shop-details-rating">
                    ...
                    <div className="it-shop-details-reviews">
                ...
                {/* <!-- price --> */}
                <div className="it-shop-details-price-wrapper mb-20">
                  <span className="it-shop-details-price old-price">$255.00</span>
                  <span className="it-shop-details-price new-price">$199.00</span>
                </div>

                {/* <!-- actions --> */}
                <div className="it-shop-details-action-wrapper">
                  <h3 className="it-shop-details-action-title">Quantity</h3>
                  <div className="it-shop-details-action-item-wrapper d-flex align-items-center">
                    <div className="it-shop-details-quantity">
                    ...
                    <div className="it-shop-details__btn ml-30 mb-15 w-100">
                      <button className="it-btn-yellow w-100 border-radius-0 d-flex justify-content-center">
                        <span>
                  ...
                  <button className="it-btn-yellow theme-bg w-100 border-radius-0">
                    <span>
                ...
                <div className="it-shop-details-action-sm">
                  <button type="button" className="it-shop-details-action-sm-btn">
