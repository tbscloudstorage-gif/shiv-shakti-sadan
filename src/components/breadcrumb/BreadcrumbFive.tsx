...
export default function BreadcrumbFive({ title = "About Us V3", subtitle = "About Us V3" }: BreadcrumbProps) {
  return (
    <>
   {/* <!-- breadcrumb-area-start --> */}
   <div className="it-breadcrumb-area it-breadcrumb-style-3 fix z-index-1" style={{backgroundImage: `url(/assets/img/shape/breadcrumb-bg-3.png)`}}>
      <div className="container">
         <div className="row align-items-center">
            <div className="col-xxl-5 col-xl-6 col-lg-6 col-md-6">
               <div className="it-breadcrumb-content z-index-1">
                  <div className="it-breadcrumb-title-box">
                     <h3 className="it-hero-5-title">{title}</h3>
                  </div>
            ...
            <div className="col-xxl-7 col-xl-6 col-lg-6 col-md-6">
               <div className="it-breadcrumb-thumb z-index-1 text-end">
                  <img src="assets/img/breadcrumb/about-v3.png" alt="" />
               </div>
            </div>
         </div>
      </div>
