...
export default function BreadcrumbCoursesDetailsv1() {
  return (
    <>
      {/* <!-- breadcrumb-area-start --> */}
      <div className="it-breadcrumb-area it-breadcrumb-course-details-style it-breadcrumb-ptb fix z-index-1"
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-xxl-6 col-xl-7 col-lg-8 col-md-7">
              <div className="it-breadcrumb-content z-index-1">
                <div className="it-breadcrumb-list-2 d-none d-lg-block">
                ...
                <div className="it-breadcrumb-author-wrapper d-none d-lg-flex align-items-center">
            ...
            <div className="col-xxl-6 col-xl-5 col-lg-4 col-md-5">
              <div className="it-breadcrumb-thumb-wrap text-end">
                <div className="it-breadcrumb-thumb thumb-overlay z-index-1">
                  <img src="assets/img/breadcrumb/course-details.jpg" alt="" />
                  <img className="it-breadcrumb-shape-2" src="assets/img/shape/breadcrumb-1-2.png" alt="" />
                  <VideoPopup>
