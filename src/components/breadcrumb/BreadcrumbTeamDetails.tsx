...
export default function BreadcrumbTeamDetails() {
  return (
    <>
      {/* <!-- breadcrumb-area-start --> */}
      <div className="it-breadcrumb-area team-details-style it-breadcrumb-course-details-style fix z-index-1"
          ...
          <div className="row align-items-center">
            <div className="col-xl-6 col-lg-6 col-md-12">
              <div className="it-breadcrumb-content z-index-1">
                <div className="it-breadcrumb-list-2">
                ...
                <div className="it-breadcrumb-list-wrap">
                  <span className="it-breadcrumb-subtitle">Adobe Certified Instructor & Adobe Certified Expert</span>
                </div>
                <div className="it-breadcrumb-title-box mb-20">
                  <h3 className="it-section-title text-white">Ethan Miller</h3>
                </div>
                <div className="it-breadcrumb-author-wrapper d-flex align-items-center">
